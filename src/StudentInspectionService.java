...
public class StudentInspectionService {
    List<String> vakitInspections = new ArrayList<>();

//    TalebeListesi talebeListesi;
//    public YoklamaListesi(TalebeListesi talebeListesi) {
//        this.talebeListesi = talebeListesi;
//    }
